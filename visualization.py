...
model_names = [{"name": "pfn_cel_03_03_15_38", "color": "red", "label": "p(y|x, D) (CEL)"},
          {"name": "pfn_nll_03_03_15_44", "color": "blue", "label": "p(y|x, D) (NLL)"}]

for i, data in enumerate(prior):
    X = data['x'].cpu()  # shape (N, F)
    y = data['y'].cpu()  # shape (N,)
